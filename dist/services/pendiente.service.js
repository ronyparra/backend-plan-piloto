      ...
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              idtipo_pendiente = _ref.idtipo_pendiente, fecha = _ref.fecha, descripcion = _ref.descripcion;
              _context3.prev = 1;
              _context3.next = 4;
      ...
      return _regenerator["default"].wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              idtipo_pendiente = _ref2.idtipo_pendiente, fecha = _ref2.fecha, descripcion = _ref2.descripcion, id = _ref2.id;
              _context4.prev = 1;
              _context4.next = 4;
